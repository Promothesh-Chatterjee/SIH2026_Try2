...
| File | Purpose |
|------|---------|
| `rf_simulation/scripts/dwell_orchestrator.py` | DwellOrchestrator, DwellConfig, DwellResult |
| `rf_simulation/tests/test_dwell_orchestrator.py` | 32 unit tests (A–P matrix) |
| `rf_simulation/scripts/proof_phase3d.py` | Manual two-dwell end-to-end proof script |
...
- `rf_simulation/scripts/per_tune_generator.py` — per-tune GNU Radio source
- `rf_simulation/tests/test_per_tune_generator.py`
