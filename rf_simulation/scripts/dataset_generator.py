...
# ---------------------------------------------------------------------------
# Path setup: rf_simulation/scripts + master src (same convention as other tools)
# ---------------------------------------------------------------------------
...
from ew_core.receiver.models import ReceiverObservation  # noqa: E402  (DwellResult.detections are DetectionObservation)
