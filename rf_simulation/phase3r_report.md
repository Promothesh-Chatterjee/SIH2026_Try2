...
Modified (unstaged):
  rf_simulation/scripts/dwell_orchestrator.py    (Phase 3P/3Q: run_generated_dwell + carrier fix)

Untracked:
  rf_simulation/phase3g_report.md through phase3q_report.md  (11 reports)
  rf_simulation/scripts/per_tune_generator.py               (Phase 3O)
  rf_simulation/tests/test_generated_dwell.py                (Phase 3P)
  rf_simulation/tests/test_per_tune_generator.py             (Phase 3O)
```
...
1. **Thin adapter** (`rf_simulation/scripts/rf_env_adapter.py`) that:
