...
class step02_single_tone(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.pri = pri = 100e-6
        self.jitter_fraction = jitter_fraction = 0.01
        ...
        self.jitter_max = jitter_max = pri * jitter_fraction
        ...
        self.pri_min = pri_min = pri - jitter_max
        self.pri_max = pri_max = pri + jitter_max
    ...
    def set_pri(self, pri):
        self.pri = pri
        self.set_jitter_max(self.pri * self.jitter_fraction)
        self.set_pri_max(self.pri + self.jitter_max)
        self.set_pri_min(self.pri - self.jitter_max)
        self.set_pri_samples(int(round(self.pri * self.samp_rate)))

    def get_jitter_fraction(self):
        return self.jitter_fraction

    def set_jitter_fraction(self, jitter_fraction):
    ...
    def get_jitter_max(self):
        return self.jitter_max

    def set_jitter_max(self, jitter_max):
    ...
    def get_pri_min(self):
        return self.pri_min

    def set_pri_min(self, pri_min):
        self.pri_min = pri_min

    def get_pri_max(self):
        return self.pri_max

    def set_pri_max(self, pri_max):
