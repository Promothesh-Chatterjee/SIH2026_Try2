...
| File | Description |
|------|-------------|
| `rf_simulation/tests/test_generated_dwell.py` | 8 tests: end-to-end, cross-center, isolation, timing, ground-truth |

## 2. Files Modified

| File | Change |
|------|--------|
| `rf_simulation/scripts/dwell_orchestrator.py` | +90 lines: `run_generated_dwell()` method, `EmitterConfig` re-export |
...
```
 M rf_simulation/scripts/dwell_orchestrator.py   (modified, unstaged)
?? rf_simulation/tests/test_generated_dwell.py   (untracked, new)
?? rf_simulation/phase3*_report.md               (untracked, phase reports)
?? rf_simulation/scripts/per_tune_generator.py   (untracked, from Phase 3O)
?? rf_simulation/tests/test_per_tune_generator.py (untracked, from Phase 3O)
```
