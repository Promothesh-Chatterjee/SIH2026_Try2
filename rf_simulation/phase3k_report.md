...
|------|---------------|-----------|-----------|
| `experiments/checkpoints/best.pt` | `1115a9095d7cfc50cc650fe7328070df3510ab62` | `ebc80c2651a590b35ba15c0d8e588828a2794b0e` | 3,259,969 |
| `experiments/checkpoints/final.pt` | `ea734bcf3fbe4dff970f4ac157f8bc7445cefed8` | `5195460241b00a45656cffce07df9150dc828d5e` | 3,259,391 |
...
```
git restore --source=HEAD -- experiments/checkpoints/best.pt experiments/checkpoints/final.pt
```
