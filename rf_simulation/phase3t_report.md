...
| File | Lines | Purpose |
|------|-------|---------|
| `rf_simulation/scripts/scheduler_translation.py` | ~130 | Translation layer |
| `rf_simulation/tests/test_scheduler_translation.py` | ~490 | 23 tests (A–N + end-to-end + equivalence) |
...
- `rf_simulation/scripts/dwell_orchestrator.py` — Phase 3P
- `experiments/checkpoints/best.pt` — Phase 3K known issue
- `experiments/checkpoints/final.pt` — Phase 3K known issue

**New untracked files (Phase 3T):**
- `rf_simulation/scripts/scheduler_translation.py`
- `rf_simulation/tests/test_scheduler_translation.py`
