...
| File | Lines | Purpose |
|------|-------|---------|
| `rf_simulation/scripts/rf_env_adapter.py` | ~130 | Thin adapter class |
| `rf_simulation/tests/test_rf_env_adapter.py` | ~280 | 17 integration tests (12-point contract) |
...
- **New untracked files:**
  - `rf_simulation/scripts/rf_env_adapter.py`
  - `rf_simulation/tests/test_rf_env_adapter.py`
