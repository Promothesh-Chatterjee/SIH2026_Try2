...
def run_sweep():
    ...
    ckpt_path = Path('experiments/checkpoints/scheduler_v2_operational_candidate/checkpoint_gate_25000_frozen.pt')
    ...
    for label, alpha_val in alpha_candidates:
        ...
        evaluator = StagedGateEvaluator(
            output_dir=Path('experiments/checkpoints/alpha_sweep_temp'),
            gates=[],
    ...
    out_file = Path('experiments/checkpoints/alpha_miss_sweep_results.json')
