...
from scripts.evaluate_canonical_10scenarios import evaluate_canonical_10scenarios
from scripts.verify_baseline_gate import CANONICAL_CKPT_SHA256, sha256_file
from ew_core.evaluation.benchmark_contract import BENCHMARK_VERSION, CANONICAL_SCENARIOS
from ew_core.evaluation.promotion_sentinel import BASELINE_GATE25K, evaluate_promotion
...
def run_full_verification() -> bool:
    ...
    candidate_dir = Path("experiments/checkpoints/safe_continuation_candidate")
    ...
    report_manifest_path = Path("experiments/reports/gate_25500_deployment_manifest.json")
