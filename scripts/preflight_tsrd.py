...
def main() -> int:
    ...
    # receiver / dwell).
    from ew_core.training.training_gate import validate_dwell_contract, validate_training_gate
    ...
    from ew_core.contracts import n_actions_for
    ...
    from ew_core.perception.adapters import BAND_FEATURES
    from ew_core.utils.checkpoint_meta import FEATURE_ORDER
