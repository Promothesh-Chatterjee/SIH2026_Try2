...
from ew_core.environment.scenario_generator import DEFAULT_GNU_DATA_PATH, DEFAULT_GNU_DIR, load_gnu_records
...
def build_scenario_records(scenario_id: str | None = None, time_horizon_us: float = 600_000.0) -> List[Dict[str, Any]]:
    ...
    if gnu_path.exists() and (gnu_path.suffix in [".json", ".npz"] or "rf_simulation" in str(gnu_path)):
