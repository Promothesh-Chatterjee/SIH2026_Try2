...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--reservoir",
        type=Path,
        default=Path("experiments/checkpoints/production_baseline/baseline_reservoir_5k.pkl"),
    )
    parser.add_argument(
        "--report",
        type=Path,
        default=Path("experiments/reports/baseline_reservoir_audit.json"),
    )
    parser.add_argument(
        "--plot",
        type=Path,
        default=Path("experiments/reports/baseline_reservoir_distribution.png"),
    )
