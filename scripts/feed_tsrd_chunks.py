...
def feed_tsrd_chunks(
    ...
    from ew_core.environment.scenario_generator import DEFAULT_GNU_DATA_PATH, load_gnu_records

    if h5_path.suffix in [".json", ".npz"] or "rf_simulation" in str(h5_path):
...
if __name__ == "__main__":
    ...
    from ew_core.environment.scenario_generator import DEFAULT_GNU_DATA_PATH, DEFAULT_GNU_DIR
