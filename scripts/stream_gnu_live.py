...
if __name__ == '__main__':
    ...
    default_gt = repo_root / "rf_simulation" / "p3ac_50k" / "episodes" / "EP000001.gt.json"
    if not default_gt.exists():
        default_gt = Path('C:/HACKATHONS/SIH2026_Try2/rf_simulation/p3ac_50k/episodes/EP000001.gt.json')
