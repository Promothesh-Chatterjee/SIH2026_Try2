...
2. Saving to separate directory: experiments/checkpoints/scheduler_v2_continuation.
...
def main():
    frozen_ckpt = Path("experiments/checkpoints/scheduler_v2_operational_candidate/checkpoint_gate_25000_frozen.pt")
    assert frozen_ckpt.exists(), f"Frozen candidate not found: {frozen_ckpt}"

    output_dir = "experiments/checkpoints/scheduler_v2_continuation"
