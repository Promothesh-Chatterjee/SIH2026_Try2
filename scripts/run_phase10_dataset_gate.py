...
def write_qualification_report(
    ...
    lines.extend([
        ...
        f"- **Monitored Dataset Files**: `{imm.get('files_monitored', imm.get('total_files_monitored', 6000)):,}`",
    ...
    lines.extend([
        ...
        f"| **Dwell-Relative First-Detection Latency** | **{stare.get('dwell_relative_first_detection_latency_us', 0):.1f} µs** | **{scan.get('dwell_relative_first_detection_latency_us', 0):.1f} µs** | Dwell-relative first-detection timing within dwell |",
        "",
        ...
        f"> The dwell-relative first-detection latency measures intercept timing within the dwell",
        f"> ({stare.get('dwell_relative_first_detection_latency_us', 0):.1f} µs STARE, {scan.get('dwell_relative_first_detection_latency_us', 0):.1f} µs SCAN).",
        "",
        "---",
        "",
