...
Usage:
  python scripts/diag_policy_comparison.py --data-dir D:/TSRD \\
      --ckpt experiments/checkpoints/scheduler/best.pt \\
...
from ew_core.contracts import DWELL_MODES, NORMAL_DWELL  # noqa: E402
from ew_core.environment.cognitive_rf_scan_env import CognitiveRFScanEnv  # noqa: E402
from ew_core.models.deinterleaver import PDWTransformerEncoder  # noqa: E402
from ew_core.models.drqn_scheduler import DRQNScheduler  # noqa: E402
from ew_core.models.smartscan_moe import SmartScanMoE  # noqa: E402
from ew_core.preprocessing.normalise import load_normalization_stats  # noqa: E402
from ew_core.telemetry.schema import coerce, shannon_entropy  # noqa: E402
from ew_core.training.val_set import FixedValidationSet  # noqa: E402
