...
Outputs full statistics into experiments/reports/benchmark_v2_multiseed_summary.json.
"""
...
def evaluate_candidates(seeds=[42, 123, 999]):
    ...
    out_file = Path("experiments/reports/benchmark_v2_multiseed_summary.json")
