...
from ew_core.environment.cognitive_rf_scan_env import CognitiveRFScanEnv, BeliefState, STATE_FEATURES_PER_BAND
...
class ObservationContractTests(unittest.TestCase):
    ...
    def test_baseline_scheduler_defaults_match_contract(self):
        ...
        from ew_core.training.thompson_sampling import ThompsonSamplingExplorer
        self.assertEqual(RandomScheduler().n_bands, 36)
        self.assertEqual(ThompsonSamplingExplorer().n_bands, 36)
        from ew_core.models.smartscan_moe import SmartScanMoE as SMoE
