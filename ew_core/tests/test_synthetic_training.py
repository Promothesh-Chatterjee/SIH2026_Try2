...
from ew_core.data.synthetic_dataset import ensure_local_fallback_dataset
from ew_core.training.train_deinterleaver import train_deinterleaver_safe
    ...
    def test_real_tsrd_missing_root_fails_without_fallback(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with self.assertRaises(FileNotFoundError):
                from ew_core.training.train_deinterleaver import train_deinterleaver
