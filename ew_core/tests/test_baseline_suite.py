...
from ew_core.contracts import NORMAL_DWELL, band_of_action, mode_of_action, n_actions_for
...
from ew_core.evaluation.baseline_suite_eval import run_baseline_suite
from ew_core.models.baseline_suite import (
    BASELINE_NAMES,
    NN_BASELINES,
    RevisitHeuristic,
    SequentialSweep,
...
class BaselineBehaviorTests(unittest.TestCase):
    ...
    def test_fixed_periodic_scan_blocks_per_band(self):
        from ew_core.models.baseline_suite import FixedPeriodicScan
...
class BaselineFairHarnessTests(unittest.TestCase):
    ...
    def test_same_world_same_seed_per_baseline(self):
        ...
        records = _records()
        env_cfg = _env_cfg()
        from ew_core.evaluation.baseline_suite_eval import run_baseline_episode
