...
from ew_core.data.synthetic_dataset import make_synthetic_pulse_train, write_synthetic_dataset
from ew_core.preprocessing.normalise import normalise_pdws, fit_train_statistics, \
    normalization_stats_hash, save_normalization_stats, load_normalization_stats
from ew_core.models.deinterleaver import PDWTransformerEncoder, deinterleave
from ew_core.training.train_deinterleaver import mine_triplets, collate_single_file_batch
...
class TestDeinterleaverPipelineRequirements(unittest.TestCase):
    ...
    def test_hdbscan_receives_embeddings_not_raw_pdws(self):
        ...
        from ew_core.models.deinterleaver import _cluster_embeddings
