...
# Verify imports
python -c "from ew_core.preprocessing.normalise import normalise_pdws; print('OK')"
python -c "from ew_core.environment.rf_scan_env import RFScanEnv; print('OK')"
python -c "from ew_core.models.deinterleaver import PDWTransformerEncoder; print('OK')"
python -c "from ew_core.models.drqn_scheduler import DRQNScheduler; print('OK')"
python -c "from ew_core.models.smartscan_moe import SmartScanMoE; print('OK')"
```
